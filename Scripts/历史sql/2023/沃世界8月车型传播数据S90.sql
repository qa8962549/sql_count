...
select o.ref_id,c.title-- ,c.上线时间
	...
	and date_create <='2022-08-31 23:59:59' and date_create >='2022-08-01 00:00:00'
	and o.ref_id='bVKItdYobG' 
	GROUP BY 1,2;
...
from
	...
	where a.create_time >= '2022-08-01 00:00:00'
	and a.create_time <='2022-08-31 23:59:59'
	and c.active_code='IBDMAUGS900SFGZS2022VCCN'   -- 沃尔沃S90
...
join 
	...
	and a.IS_DELETED = 0
	and a.CREATED_AT BETWEEN '2022-08-01 00:00:00' and '2022-08-31 23:59:59'
