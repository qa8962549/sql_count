...
from 
	...
	where 1=1
	--and a.create_time >= '2023-04-05' and a.create_time <= '2023-04-25 23:59:59'   -- 订单时间
	...
	and b.spu_type in (51121001,51121004) -- 精品
	order by a.create_time ) x 
left join cyxdms_retail.tt_sales_orders b on x.member_phone=b.customer_tel and x.rk=1